...
window.onload = function animationProject() {
    ...
    let tokenId, animationID, longitude, latitude, keyId = "8SdUOIMUJzlXswkGbSVInlBgxi17ejOI";
    ...
    document.getElementById("login").addEventListener('click', async function () {
        ...
        /**
         *This function request the user to access his/her location
        * It takes two parameters
        ...
        function success(position) {
            ...
            async function findLocation() {
                try {
                    /**
                     * This function fetch (get) allow to get the geolocation address of the user
                     *  based on access id, the latitude and longitude information
